from Artifacts_MMO_Client.requester import SendRequest
...
class MockRequests:
    @staticmethod
    def get(url: str, headers: dict[str, str], params: dict[str, str] = {}) -> MockResponse:
        return MockResponse()
...
def test_get() -> None:
    api_requester: SendRequest = SendRequest(MockRequests())
